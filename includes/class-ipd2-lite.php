...
class IPD2_Lite {
	...
	public function __construct( $ip=null, $agent=null, $referer=null, $file='ipd.csv' ) {
		...
		$this->result['name'] = null; // google
		$this->result['type'] = null; // CRAWLER, ADMIN

		if ( !($docroot = $_SERVER['DOCUMENT_ROOT']) ) { $docroot = dirname( $_SERVER['SCRIPT_FILENAME'] ); }
	...
	public static function cloudflare_incap() {
